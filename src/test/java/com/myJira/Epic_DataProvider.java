...
public class Epic_DataProvider {
	
	@DataProvider(name="epic")
	public Object[][] getEpicData() throws Exception
	{
		//Read data from excel
		//String path = System.getProperty("user.dir")+"/src/test/java/com/Jira/Utilities/Epic.xlsx";
		
		String path=System.getProperty("user.dir");
		File f=new File(path+"\\src\\test\\java\\com\\Jira\\Utilities\\Epic.xlsx");
